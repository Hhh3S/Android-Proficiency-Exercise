...
*/
public class ResultsDao extends AbstractDao<Results, String> {

    public static final String TABLENAME = "RESULTS";

    /**
     * Properties of entity Results.<br/>
    ...
    public ResultsDao(DaoConfig config) {
        super(config);
    }
    
    public ResultsDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"RESULTS\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"RESULTS\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, Results entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Results entity) {
        stmt.clearBindings();
    ...
    @Override
    public Results readEntity(Cursor cursor, int offset) {
    ...
    @Override
    public void readEntity(Cursor cursor, Results entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(Results entity, long rowId) {
        return entity.get_id();
    }
    
    @Override
    public String getKey(Results entity) {
        if(entity != null) {
            return entity.get_id();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(Results entity) {
